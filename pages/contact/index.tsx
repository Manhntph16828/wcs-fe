            ...
            <div className="main w-[1240px] mx-auto mt-[112px] grid grid-cols-2">
                <div className="mr-[81px]">
                    ...
                    <span className="text-[#6E6F7E] ">Nếu bạn muốn biết thêm về các chính sách của chúng tôi, bạn có thể tham khảo
                        ...
                        <a href="./cart/cancelorder" className="text-[#E22C43]">Bấm vào đây.</a>
                    </span>
                    <div className="mt-[40px]">
                        <div className="flex">
                            <svg className='mt-[8px]' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex py-[20px]">
                            <svg className='mt-[8px]' width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex">
                            <svg className='mt-[8px]' width="30" height="22" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
